    ...
    <>
      ...
      <section className="px-6 pb-10 max-w-7xl mx-auto w-full">
        <div className="mb-3">
          ...
          <p className="text-xs text-slate-500 mt-1">Agendamento central de campanhas, bids e placements. As regras são persistidas em AmazonScheduledRule e executadas pelo motor existente.</p>
        </div>
        {loading
