...
function mountLiveChart() {
  ...
  const existing = document.querySelector('[data-dashboard-live-chart-root="true"]');
  if (existing) {
  ...
  container.setAttribute('data-dashboard-live-chart-root', 'true');
  container.className = 'contents';
  legacyCard.insertAdjacentElement('afterend', container);

  mountedContainer = container;
  mountedRoot = createRoot(container);
  mountedRoot.render(<LivePerformanceChart />);
}
