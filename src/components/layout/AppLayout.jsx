...
import {
  ...
  Zap, Bell, Bot, ShoppingBag, FileText, BarChart2, Search, Target, Link2, Brain, Clock, Book, AlertTriangle, Shield
} from 'lucide-react';
...
const navItems = [
  ...
  { path: '/negative-keywords', icon: Shield, label: 'Palavras Negativas' },
