...
Deno.serve(async (req) => {
  try {
    ...
    const toSave = records.map((r: any) => ({
      ...
      same_sku_orders: Number(r.promotedPurchases14d || 0),
      same_sku_sales: Number(r.promotedSales14d || 0),
      same_sku_units: Number(r.promotedUnitsSold14d || 0),
      total_attributed_sales: Number(r.sales14d || 0),
