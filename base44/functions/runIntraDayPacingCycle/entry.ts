 ...
 *
 * A função canônica de sincronização controla sua própria frequência conforme
 * AutopilotConfig.native_rules_sync_frequency_hours. Este wrapper apenas
 * preserva a rota histórica e a ordem operacional.
 */
